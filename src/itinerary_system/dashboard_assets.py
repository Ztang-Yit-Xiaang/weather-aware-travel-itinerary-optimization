"""Static assets for the full interactive dashboard.

Keeping these assets outside the exporter makes asset ownership explicit while
leaving payload construction and write ordering unchanged.
"""

from __future__ import annotations

DASHBOARD_STYLESHEET = """:root {
  --forest: #0a6b53;
  --forest-dark: #064738;
  --teal: #18b8a5;
  --teal-soft: #d9fbf6;
...
def dashboard_stylesheet() -> str:
    """Return the full dashboard stylesheet exactly as exported."""
