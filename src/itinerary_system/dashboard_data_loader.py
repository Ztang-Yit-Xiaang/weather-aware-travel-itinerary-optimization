"""Static data-loading runtime for the full interactive dashboard."""

from __future__ import annotations

DASHBOARD_DATA_LOADER_SCRIPT = """const DASHBOARD_HINT = 'If fallback assets are missing, run: python scripts/serve_dashboard.py';
...
def dashboard_data_loader_script() -> str:
    """Return the dashboard data-loader script exactly as exported."""
    return DASHBOARD_DATA_LOADER_SCRIPT