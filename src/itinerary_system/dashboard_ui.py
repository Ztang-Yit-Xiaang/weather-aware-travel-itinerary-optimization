"""Static UI rendering runtime for the full interactive dashboard."""

from __future__ import annotations

DASHBOARD_UI_SCRIPT = """function renderDashboardMetrics(metrics) {
...
def dashboard_ui_script() -> str:
    """Return the dashboard UI script exactly as exported."""
    return DASHBOARD_UI_SCRIPT