"""Static map interaction runtime for the full interactive dashboard."""

from __future__ import annotations

DASHBOARD_MAP_CONTROLS_SCRIPT = """let dashboardMap = null;
...
def dashboard_map_controls_script() -> str:
    """Return the map-controls script exactly as exported."""
    return DASHBOARD_MAP_CONTROLS_SCRIPT